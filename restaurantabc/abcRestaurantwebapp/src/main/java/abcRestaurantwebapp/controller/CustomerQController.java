...
/**
 * Servlet implementation class CustomerQController
 */
@WebServlet(name = "CustomerQController", urlPatterns = {"/CustomerQController"})

public class CustomerQController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CustomerQController() {
        super();
	...
	ServletUtility.forward(ARWView.CustomerQ, request, response);
}
